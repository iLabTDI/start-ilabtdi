...
import { useAuth, loginSchema, type LoginFormValues } from '@/lib/auth';
import { AUTH_ROUTES } from '@/lib/constants';
import { safeRedirectPath } from '@/lib/utils';
import { isDemoMode } from '@/lib/env';
import { DEMO_ACCOUNTS } from '@/lib/auth-service';
    ...
    <button
      ...
      onClick={() =>
        toast.info(`${label} · próximamente`, {
          description: 'Conecta OAuth en src/lib/auth-service.ts cuando lo necesites.',
        })
      }
